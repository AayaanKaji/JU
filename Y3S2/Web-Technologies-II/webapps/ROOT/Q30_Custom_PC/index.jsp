...
<form action="/Q30_Custom_PC/calculatePrice.jsp" method="POST">
<%
    try {
        ...
        ResultSet typesRs = stmt.executeQuery("SELECT DISTINCT component_type FROM 1100_components");
        ...
        while (typesRs.next()) {
            ...
            PreparedStatement ps = conn.prepareStatement(
                "SELECT manufacturer, model FROM 1100_components WHERE component_type = ?");
            ps.setString(1, type);
