...
public class InsertDataServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Insert into 1100_departments
            String deptSQL = "INSERT INTO 1100_departments (name) VALUES (?) ON DUPLICATE KEY UPDATE name = name;";
            ...
            // Insert into 1100_users
            String userSQL = "INSERT INTO 1100_users (login_name, password, email, first_name, last_name, phone) VALUES (?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE login_name = login_name;";
            ...
            // Insert into 1100_students
            String studentSQL = "INSERT INTO 1100_students (name, deptID) VALUES (?, ?) ON DUPLICATE KEY UPDATE name = name;";
            ...
            // Insert into 1100_states table
            String stateSQL = "INSERT INTO 1100_states (name) VALUES (?) " +
            ...
            String stateIdQuery = "SELECT id, name FROM 1100_states;";
            ...
            // Insert into 1100_districts table
            String distSQL = "INSERT INTO 1100_districts (name, description, state_id) VALUES (?, ?, ?) " +
                    "ON DUPLICATE KEY UPDATE name = name;";
            ...
            // INsert into 1100_components
            String sql = "INSERT INTO 1100_components (component_type, manufacturer, model, price) " +
                    "VALUES (?, ?, ?, ?) " +
            ...
            // Insert into 1100_semesters table
            String semesterSQL = "INSERT INTO 1100_semesters (semester_id, semester_name) VALUES (?, ?) " +
            ...
            // Insert into 1100_subjects table
            String subjectSQL = "INSERT INTO 1100_subjects (subject_code, subject_name) VALUES (?, ?) " +
            ...
            String studentsQuery = "SELECT roll FROM 1100_students";
            ...
            String semestersQuery = "SELECT semester_id FROM 1100_semesters";
            ...
            String subjectsQuery = "SELECT subject_code FROM 1100_subjects";
            ...
            String insertMarksSQL = "INSERT INTO 1100_marks (roll, subject_code, semester_id, marks) VALUES (?, ?, ?, ?)";
