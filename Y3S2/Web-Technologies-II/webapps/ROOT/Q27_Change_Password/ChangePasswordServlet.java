...
public class ChangePasswordServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String selectSql = "SELECT password FROM 1100_users WHERE LOWER(login_name) = LOWER(?)";
            ...
            String updateSql = "UPDATE 1100_users SET password = ? WHERE LOWER(login_name) = LOWER(?)";
