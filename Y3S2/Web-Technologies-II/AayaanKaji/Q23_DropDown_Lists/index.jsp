  ...
  <body>
    <div class="container">
      ...
      <select id="states" onchange="populateDistricts()">
        ...
        conn.prepareStatement("SELECT name FROM states ORDER BY name");
    ...
    <script>
      function populateDistricts() {
        ...
        fetch("/AayaanKaji/Q23_DropDown_Lists/getDistricts.jsp", {
          method: "POST",
          headers: {
      ...
      function showDistrictInfo() {
          ...
          fetch("/AayaanKaji/Q23_DropDown_Lists/getDistrictInfo.jsp", {
            method: "POST",
            headers: {
                "Content-Type": "application/x-www-form-urlencoded",
          },
